...
public class RssLoaderService extends IntentService {
    private static final String ACTION_GET_ALL = "ru.ifmo.md.lesson6.action.GET_ALL";
    private static final String ACTION_GET_SINGLE = "ru.ifmo.md.lesson6.action.GET_SINGLE";

    private static final String EXTRA_SINGLE_ID = "ru.ifmo.md.lesson6.extra.SINGLE_ID";
